...
These rules define how to create and organize React components. Use this guide when generating NEW components to ensure they follow the established patterns. When REFACTORING existing components display the suggestion and await confirmation before applying the change.
