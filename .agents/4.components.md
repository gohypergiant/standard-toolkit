...
These rules define how to create and organize components in `packages/design-toolkit/src/components`. Use this guide when generating NEW components to ensure they follow the established patterns.
