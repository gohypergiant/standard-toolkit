...
- **Component Placement:** To prevent unnecessary re-renders of heavy UI trees, "move state down" to the smallest possible branch, or use "Component as Props" (passing elements as props) so they aren't affected by the parent’s state changes.
