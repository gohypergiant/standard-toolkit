...
export const DrawerStyles = tv({
  slots: {
    ...
    content:
      'relative flex h-full flex-col bg-surface-default duration-300 ease-in-out',
    inner: 'flex flex-1 flex-col p-l font-light text-body-m text-default-dark',
    attachedTrigger:
  ...
  variants: {
    position: {
      ...
      top: {
        ...
        content: 'h-[320px] w-full flex-row',
        attachedTrigger: '-translate-y-1/2 top-1/2',
      },
      bottom: {
