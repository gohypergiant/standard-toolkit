...
const { overlay, content, modal, dialog, attachedTrigger, header, footer } = DrawerStyles();
...
const DrawerFooter = ({children, className}: {children: ReactNode;className?: string;}) => {
