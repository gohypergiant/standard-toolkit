...
const { overlay, content, inner, attachedTrigger, header } = DrawerStyles();
...
const DrawerTrigger = ({
  ...
  if (typeof children === 'function') {
    return children({ isOpen: context.isOpen, onPress: handlePress });
  }
...
const DrawerHeader = ({ children }: { children: ReactNode }) => {
  ...
  return (
    ...
    >
      <div className='mb-s text-default-light text-header-l'>{children}</div>
