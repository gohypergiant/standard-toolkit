...
import type { DialogProps as DSDialogProps } from './types';
...
const DialogBody = forwardRef<HTMLDivElement, DSDialogProps>(
  ({ children, ...rest }, ref) => {
    const {
      size,
      isDismissable,
  ...
  return (
    <div
      className={cn(
        ...
        //margin is hardcoded to match the spacing values
        size === 'sm' && 'mt-[16px]',
        size === 'lg' && 'mt-[24px]',
        className,
      )}
