...
The Checkbox supports all the `Checkbox` [props and events from `react-aria-components`](https://react-spectrum.adobe.com/react-aria/Checkboxhtml#props).
...
[Docs](https://react-spectrum.adobe.com/react-aria/Checkboxhtml)
