...
export const CheckboxStyles = tv({
  slots: {
    ...
    control: [
      ...
      'group-enabled/checkbox:group-indeterminate/checkbox:bg-highlight group-enabled/checkbox:group-indeterminate/checkbox:outline-accent-bold',
      ...
      'group-enabled/checkbox:group-selected/checkbox:bg-highlight group-enabled/checkbox:group-selected/checkbox:outline-accent-bold',
