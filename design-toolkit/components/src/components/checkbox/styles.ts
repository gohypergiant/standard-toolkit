...
export const CheckboxStyles = tv({
  slots: {
    ...
    control: [
      ...
      'group-enabled/checkbox:group-indeterminate/checkbox:bg-accent-primary-bold group-enabled/checkbox:group-indeterminate/checkbox:outline-accent-primary-bold',
      ...
      'group-enabled/checkbox:group-selected/checkbox:bg-accent-primary-bold group-enabled/checkbox:group-selected/checkbox:outline-accent-primary-bold',
