...
// Add useContext method to TreeContext
TreeContext.useContext = () => useContext(TreeContext);
...
// Add useContext method to TreeItemContext
TreeItemContext.useContext = () => useContext(TreeItemContext);
