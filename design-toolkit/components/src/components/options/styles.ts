...
export const OptionsStyles = tv({
  slots: {
    ...
    item: [
      ...
      'enabled:hover:fg-inverse-bold',
      'enabled:focus-visible:fg-inverse-bold enabled:focus-visible:outline-interactive-hover',
    ...
    icon: [
      ...
      'group-enabled/options-item:group-hover/options-item:group-color-info/options-item:fg-inverse-bold',
      'group-enabled/options-item:group-focus-visible/options-item:group-color-info/options-item:fg-inverse-bold',
      'group-enabled/options-item:group-color-serious/options-item:fg-serious-bold',
      'group-enabled/options-item:group-hover/options-item:group-color-serious/options-item:fg-inverse-bold',
      'group-enabled/options-item:group-focus-visible/options-item:group-color-serious/options-item:fg-inverse-bold',
    ],
    label: [
      'truncate',
      'group-enabled/options-item:group-color-info/options-item:fg-primary-bold',
    ...
    description: [
      ...
      'group-enabled/options-item:group-hover/options-item:fg-inverse-bold',
      'group-enabled/options-item:group-focus-visible/options-item:fg-inverse-bold',
