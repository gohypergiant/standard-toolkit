...
export const OptionsStyles = tv({
  slots: {
    ...
    item: [
      ...
      'selected:inset-shadow-[3px_0_0_0_]',
      // info
      ...
      'color-serious:enabled:selected:hover:inset-shadow-[color:var(--outline-serious-hover)] color-serious:enabled:selected:hover:bg-serious-bold',
      ...
      'disabled:inset-shadow-[color:var(--outline-interactive)] disabled:selected:bg-interactive-disabled',
    ],
