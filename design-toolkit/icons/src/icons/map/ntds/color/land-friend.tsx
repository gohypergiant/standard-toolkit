...
const SvgLandFriend = ({
  ...
  >
    ...
    <path
      ...
      fill='1484F4'
    />
    <path d='M12 10L14 12L12 14L10 12L12 10Z' fill='1484F4' />
    <path d='M13 23H11V19H13V23Z' fill='1484F4' />
    <path d='M23 11V13H19V11H23Z' fill='1484F4' />
    <path d='M5 13H1V11H5V13Z' fill='1484F4' />
    <path d='M13 5H11V1H13V5Z' fill='1484F4' />
  </svg>
);
export default SvgLandFriend;
