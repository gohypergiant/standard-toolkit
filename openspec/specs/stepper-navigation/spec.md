---
related: [stepper-accessibility, stepper-composition, stepper-state-management, stepper-styling]
...
Defines navigation behavior for Stepper components including sequential forward/backward navigation, disabled step blocking, direct step selection, synchronous validation callbacks, and programmatic navigation methods.
