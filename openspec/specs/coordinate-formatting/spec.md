---
related: []
last_touched_by: consolidate-coordinate-formatting-into-geo
last_touched_on: 2026-09-10
---

## Purpose

Structured, per-part coordinate formatting (DD/DDM/DMS/MGRS/UTM) in `@accelint/geo` — the parts data model, carry/precision rules, boundary handling, and out-of-range signaling that string formatters compose over.
