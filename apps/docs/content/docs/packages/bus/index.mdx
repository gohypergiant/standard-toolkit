---
title: "Overview"
description: The @accelint/bus package provides a type-safe event bus for emitting and listening to events across browser contexts (tabs, windows, iframes). It's built on top of the native BroadcastChannel API and includes React hooks for seamless integration.
source: packages/bus/src/index.ts
source_sha: 3a165d8f4fcefdb569e96058bba87c59250d0703
doc_sha: 1ad198c4fd3a1e26a71522a436415be70a88ca5c
deprecated: false
updated: 2026-07-13
---
