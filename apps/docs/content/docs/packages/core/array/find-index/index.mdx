---
title: "@accelint/core/array/find-index"
...
Returns the index of the first element in an array that satisfies a predicate function. Returns `-1` if no element matches.
