---
title: "@accelint/core/object/lens"
...
Functional lenses for composable get/set operations on nested data structures. Lenses provide a principled way to focus on and manipulate specific properties within complex objects.
