...
doc_sha: 4c057fcbb0de75d679dd2e75accb2e5e59ad70b4
deprecated: false
updated: 2026-07-14
---
...
| [coordinates](./coordinates/index.md) | Default empty coordinate value using NaN to avoid "Null Island" at [0,0] |
| [units](./units/index.md) | SI-compliant display symbols for distance units and bidirectional mapping |
