---
title: "@accelint/core/logical/nullish-or"
...
Nullish coalescing (??) for values and function results. Returns the first operand if it's not `null` or `undefined`, otherwise returns the second operand.
