...
describe('hotkeyStore', () => {
  ...
  describe('registerHotkey', () => {
    ...
    it('should register a hotkey with multiple keys', () => {
      ...
      expect(hotkeyStore.getState().registeredKeyCominations.size).toBe(2);

      expect(
        hotkeyStore.getState().registeredKeyCominations.get(keyA.id),
      ).toEqual([hotkeyConfig.id]);

      expect(
        hotkeyStore.getState().registeredKeyCominations.get(keyB.id),
      ).toEqual([hotkeyConfig.id]);
    });
  ...
  describe('unregisterHotkey', () => {
    ...
    it('should remove the hotkey from the registeredKeyCombinations', () => {
      ...
      expect(
        hotkeyStore.getState().registeredKeyCominations.get(keyId),
      ).toBeDefined();
    ...
    it('should remove the hotkey from the activeKeyCombinations', () => {
      ...
      expect(
        hotkeyStore.getState().activeKeyCombintations.get(keyId),
      ).toBeDefined();
    ...
    it('should only remove the specific hotkey from the activeKeyCombinations', () => {
      ...
      expect(hotkeyStore.getState().activeKeyCombintations.get(keyId)).toEqual([
