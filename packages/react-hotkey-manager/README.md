...
// src/apps/layout.tsx
import { globalBind } from '@accelint/react-hotkey-manager';
...
import { registerHotkey, Keycode } from '@accelint/react-hotkey-manager';
...
```typescript
import { registerHotkey, Keycode, isMac } from '@accelint/react-hotkey-manager';
...
1. List `@accelint/react-hotkey-manager` as a peer dependency
