...
You might have rare instances where you do need to use a border and there. For example, if you need a line only at the top of a div. In this situation, use an outline semantic color variable directly to ensure consistency with the color system:
