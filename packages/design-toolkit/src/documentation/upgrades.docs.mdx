...
# Upgrade to v8
This guide explains how to migrate from Design Toolkit v7 to v8. You can also migrate from an earlier version, but if you are still on a v4 or earlier, it would be better to two-step it: first migrate to v5 and then to v8. [Go directly to migration steps](#migration)
