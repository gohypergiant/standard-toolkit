...
- **[DrawerLayout](?path=/docs/components-drawerlayout--docs)** - Layout container for panel positioning
...
- Integrates with [ViewStack](?path=/docs/components-viewstack--docs) for stacked navigation
- Only one DrawerPanel allowed per Drawer; DrawerMenu is optional

**Related:**
- [DrawerLayout](?path=/docs/components-drawerlayout--docs)
- [ViewStack](?path=/docs/components-viewstack--docs)
