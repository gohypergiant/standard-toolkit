...
Pass a number to create evenly distributed markers along the track.

<Canvas of={SliderStories.WithEvenlySpacedMarkers} />

### Specific Value Markers
Pass an array of numbers to place markers at specific values.

<Canvas of={SliderStories.WithSpecificMarkerValues} />
...
<Canvas of={SliderStories.WithDetailedLabeledMarkers} />

### Vertical Slider with Markers
Markers work with vertical orientation as well.

<Canvas of={SliderStories.VerticalWithMarkers} />
...
- Form integration
- Value announcements
- Tooltip display for current values on hover
