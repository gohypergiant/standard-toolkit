...
type Element =
  ...
  | { type: 'open-bracket'; timeMs: number }
  | { type: 'close-bracket'; timeMs: number }
...
export const ROWS: Row[] = [
  {
    ...
    elements: [
      // Tue Jan 27 — 12:00 AM
      { type: 'open-bracket', timeMs: 1769472000000 },
      ...
      // Tue Jan 27 — 4:00 AM
      { type: 'close-bracket', timeMs: 1769486400000 },

      // Tue Jan 27 — 4:15 AM
      { type: 'open-bracket', timeMs: 1769487300000 },
      ...
      // Thu Jan 29 — 11:00 AM
      { type: 'open-bracket', timeMs: 1769691600000 },
      // Thu Jan 29 — 11:00 AM - 12:00 PM
      { type: 'spacer', rangeMs: [1769691600000, 1769695200000] },
      // Thu Jan 29 — 12:00 PM
      { type: 'close-bracket', timeMs: 1769695200000 },
...

  {
    ...
    elements: [
      ...
      // Tue Jan 27 — 5:25 AM
      { type: 'open-bracket', timeMs: 1769491500000 },
      ...
      // Tue Jan 27 — 9:10 AM
      { type: 'close-bracket', timeMs: 1769505000000 },
      ...
      // Wed Jan 28 — 10:40 PM
      { type: 'open-bracket', timeMs: 1769640000000 },
      // Wed Jan 28 — 10:40 PM - 11:30 PM
      { type: 'spacer', rangeMs: [1769640000000, 1769643000000] },
      // Wed Jan 28 — 11:30 PM
      { type: 'close-bracket', timeMs: 1769643000000 },
...

  {
    ...
    elements: [
      ...
      // Tue Jan 27 — 6:46 PM
      { type: 'close-bracket', timeMs: 1769540160000 },

      // Tue Jan 27 — 6:50 PM
      { type: 'open-bracket', timeMs: 1769540400000 },
      ...
      // Thu Jan 29 — 10:00 AM
      { type: 'open-bracket', timeMs: 1769700000000 },
      // Thu Jan 29 — 10:00 AM - 10:40 AM
      { type: 'spacer', rangeMs: [1769700000000, 1769702400000] },
      // Thu Jan 29 — 10:40 AM
      { type: 'close-bracket', timeMs: 1769702400000 },
...

  {
    ...
    elements: [
      ...
      // Wed Jan 28 — 5:10 AM
      { type: 'open-bracket', timeMs: 1769577000000 },
      ...
      // Wed Jan 28 — 1:30 PM
      { type: 'close-bracket', timeMs: 1769607000000 },
      ...
      // Thu Jan 29 — 2:20 PM
      { type: 'open-bracket', timeMs: 1769706000000 },
      // Thu Jan 29 — 2:20 PM - 2:50 PM
      { type: 'spacer', rangeMs: [1769706000000, 1769707800000] },
      // Thu Jan 29 — 2:50 PM
      { type: 'close-bracket', timeMs: 1769707800000 },
...

  {
    ...
    elements: [
      ...
      // Tue Jan 27 — 6:39 PM
      { type: 'open-bracket', timeMs: 1769539980000 },
      // Tue Jan 27 — 6:39 PM - 8:00 PM
      { type: 'spacer', rangeMs: [1769539980000, 1769544000000] },
      // Tue Jan 27 — 8:00 PM
      { type: 'close-bracket', timeMs: 1769544000000 },
      ...
      // Wed Jan 28 — 12:00 PM
      { type: 'open-bracket', timeMs: 1769601600000 },
      ...
      // Wed Jan 28 — 8:30 PM
      { type: 'close-bracket', timeMs: 1769632200000 },
...

  {
    ...
    elements: [
      ...
      // Wed Jan 28 — 8:30 AM
      { type: 'open-bracket', timeMs: 1769589000000 },
      ...
      // Thu Jan 29 — 6:30 PM
      { type: 'close-bracket', timeMs: 1769704200000 },
...

  {
    ...
    elements: [
      ...
      // Tue Jan 27 — 2:00 AM
      { type: 'open-bracket', timeMs: 1769479200000 },
      ...
      // Thu Jan 29 — 1:00 PM
      { type: 'close-bracket', timeMs: 1769691600000 },
      ...
      // Fri Jan 30 — 7:50 AM
      { type: 'close-bracket', timeMs: 1769759400000 },
    ],
  },

  {
    ...
    elements: [
      ...
      // Tue Jan 27 — 6:00 AM
      { type: 'open-bracket', timeMs: 1769493600000 },
      ...
      // Wed Jan 28 — 11:10 PM
      { type: 'close-bracket', timeMs: 1769641800000 },
      ...
      // Thu Jan 29 — 10:30 PM
      { type: 'close-bracket', timeMs: 1769725800000 },
...

  {
    ...
    elements: [
      ...
      // Wed Jan 28 — 7:00 AM
      { type: 'open-bracket', timeMs: 1769583600000 },
...

  {
    ...
    elements: [
      ...
      // Tue Jan 27 — 9:40 PM
      { type: 'open-bracket', timeMs: 1769550000000 },
      // Tue Jan 27 — 9:40 PM - 10:30 PM
      { type: 'spacer', rangeMs: [1769550000000, 1769553000000] },
      // Tue Jan 27 — 10:30 PM
      { type: 'close-bracket', timeMs: 1769553000000 },
      ...
      // Wed Jan 28 — 3:00 PM
      { type: 'close-bracket', timeMs: 1769612400000 },
...

  {
    ...
    elements: [
      ...
      // Wed Jan 28 — 8:46 AM
      { type: 'open-bracket', timeMs: 1769589960000 },
      // Wed Jan 28 — 8:46 AM - 9:00 AM
      { type: 'spacer', rangeMs: [1769589960000, 1769590800000] },
      // Wed Jan 28 — 9:00 AM
      { type: 'close-bracket', timeMs: 1769590800000 },
      ...
      // Wed Jan 28 — 3:45 PM
      { type: 'close-bracket', timeMs: 1769615100000 },
...

  {
    ...
    elements: [
      ...
      // Tue Jan 27 — 11:33 AM
      { type: 'open-bracket', timeMs: 1769511960000 },
      // Tue Jan 27 — 11:33 AM - 12:23 PM
      { type: 'spacer', rangeMs: [1769511960000, 1769514960000] },
      // Tue Jan 27 — 12:23 PM
      { type: 'close-bracket', timeMs: 1769514960000 },
      ...
      // Wed Jan 28 — 11:00 AM
      { type: 'close-bracket', timeMs: 1769598000000 },
...

  {
    ...
    elements: [
      ...
      // Tue Jan 27 — 2:30 AM
      { type: 'open-bracket', timeMs: 1769481000000 },
...

  {
    ...
    elements: [
      ...
      // Tue Jan 27 — 5:00 PM
      { type: 'open-bracket', timeMs: 1769533200000 },
      ...
      // Wed Jan 28 — 9:46 AM
      { type: 'open-bracket', timeMs: 1769599960000 },
      // Wed Jan 28 — 9:46 AM - 10:00 AM
      { type: 'spacer', rangeMs: [1769599960000, 1769601600000] },
      // Wed Jan 28 — 10:00 AM
      { type: 'close-bracket', timeMs: 1769601600000 },
      ...
      // Wed Jan 28 — 8:00 PM
      { type: 'close-bracket', timeMs: 1769637600000 },
