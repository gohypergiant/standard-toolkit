...
| `showNumerals` | `boolean` | `true` | Render the numeral column at all (false omits it entirely) |
| `density` | `'cozy' \| 'compact'` | `'cozy'` | Cell density; compact tightens padding and prevents wrapping |
