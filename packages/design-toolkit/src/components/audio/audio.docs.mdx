...
Enable looping to automatically restart playback when the audio ends.

<Canvas of={AudioStories.Looping} />

## Error State

When audio fails to load, an error message is displayed and controls are automatically disabled.

<Canvas of={AudioStories.ErrorState} />
## Props
