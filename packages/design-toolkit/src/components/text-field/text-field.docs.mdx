...
* **`isReadOnly`** - Marks the text field as readonly
* **`isInvalid`** - Marks the text field as invalid
* **`inputProps`** - Additional props passed to the underlying [Input](?path=/docs/components-input--playground#props) component:
