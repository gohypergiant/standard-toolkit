...
- 9a25205: Change transports behavior to no longer be additive, it now replaces default / implicit stdout transports. By default, the logger writes to a single console transport (pretty-printed in development, structured
