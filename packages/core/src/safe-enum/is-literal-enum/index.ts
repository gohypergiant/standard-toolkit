 ...
 * @internal
 */
type IsLiteralEnumForPrimitive<TObject, TPrimitive> =
  TObject extends Record<string, TPrimitive>
 ...
 * @internal
 */
export type IsLiteralEnum<TObject> =
  IsLiteralEnumForPrimitive<TObject, string> extends false
