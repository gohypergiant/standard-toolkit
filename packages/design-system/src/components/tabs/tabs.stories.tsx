 ...
 */
export const Stacked: StoryObj<TabListProps<object>> = {
  render: (props) => {
          ...
          <TabPanels shouldForceMount>
            ...
            <TabPanel id='c'>
              <p>
                ...
                vitae accumsan elit. Maecenas egestas porttitor felis, non
                auctor tortor consequat ut. Etiam at nibh eget ante suscipit
                varius et quis diam. Nullam a tortor urna. Donec vitae risus et
                lorem pellentesque varius. Duis vulputate neque est, nec gravida
                erat efficitur sit amet. Sed efficitur tincidunt erat.
              </p>
              <p>
                Nulla feugiat ut sem vitae maximus. Mauris blandit arcu tempor
                porta sagittis. Cras tincidunt at turpis ac tempor. In nulla
                tortor, egestas id arcu ac, venenatis tempor urna. Integer a
                lorem vehicula, pulvinar massa in, placerat nunc. Quisque sed
                consectetur justo, ut malesuada enim. Vivamus imperdiet
                dignissim eros ac ultricies. Sed laoreet suscipit justo sit amet
                tincidunt.
              </p>
            </TabPanel>
          </TabPanels>
...
export const Solo: StoryObj<TabListProps<object>> = {
  render: (props) => {
    const axis = props.orientation === 'vertical' ? 'row' : 'column';
    const direction: CSSProperties['flexDirection'] = `${axis}${props.anchor === 'start' ? '-reverse' : ''}`;
    ...
    return (
      <Tabs onSelectionChange={action('onSelectionChange')}>
        ...
        <p>
          NOTE: This content should move because the lack of a content stack
          will cause content below it to shift up/down based on the rendered tab
        </p>
      </Tabs>
    );
  },
