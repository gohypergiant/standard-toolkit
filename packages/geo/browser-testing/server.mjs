 ...
 * - /browser-testing/positive.html - Test WITH compatibility transforms
 * - /browser-testing/negative.html - Test WITHOUT compatibility transforms
 * - /dist/* - The built package files (with transforms)
 * - /dist-no-transforms/* - The built package files (without transforms)
 *
 * @module server
 */
