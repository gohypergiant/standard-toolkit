...
| -------------------------------- | --------------------- | ------------------ | --------------------- |
| **Package only (minified)**      | 13.6 KB               | 14.6 KB            | +1.0 KB (+7.4%)       |
| **Package only (gzipped)**       | 4.8 KB                | 5.6 KB             | +0.8 KB (+16.7%)      |
| **With dependencies (minified)** | 33.2 KB               | 14.6 KB            | **-18.6 KB (-56.0%)** |
| **With dependencies (gzipped)**  | 11.1 KB               | 5.6 KB             | **-5.5 KB (-49.5%)**  |
