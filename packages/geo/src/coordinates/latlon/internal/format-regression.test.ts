...
describe('DD/DDM/DMS byte-identical regression', () => {
  it.each`
    ...
    ${'signed sub-1e-6'}     | ${-1e-7}      | ${-5e-7}      | ${false}    | ${'-0.000000°, -0.000000°'}
  ...
  it.each`
    ...
    ${'negative (signed)'}   | ${-12.345678} | ${-23.456789} | ${false}    | ${"12° 20.7407', 23° 27.4073'"}
  ...
  it.each`
    ...
    ${'negative (signed)'}   | ${-12.345678}                     | ${-23.456789} | ${false}    | ${"12° 20' 44.44″, 23° 27' 24.44″"}
