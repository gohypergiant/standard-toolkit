...
Available units (from `@accelint/map-toolkit/shared/units`):
- `'km'` - Kilometers
- `'m'` - Meters
...
// Supported units (derived from shared/units)
type SupportedDistanceUnit = DistanceUnitAbbreviation; // 'km' | 'm' | 'nm' | 'mi' | 'ft'
...
The `@accelint/map-toolkit/shared/units` module provides unit conversion utilities used across map-toolkit:
...
// Convert abbreviation to Turf.js unit name
getDistanceUnitFromAbbreviation('nm'); // 'nauticalmiles'
getDistanceUnitFromAbbreviation('km'); // 'kilometers'

// Convert Turf.js unit name to abbreviation
getDistanceUnitAbbreviation('nauticalmiles'); // 'nm'
getDistanceUnitAbbreviation('kilometers');    // 'km'
