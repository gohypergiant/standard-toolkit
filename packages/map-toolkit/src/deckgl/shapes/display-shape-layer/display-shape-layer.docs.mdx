...
2. **Coffin corners** (Point shapes with icons): Bracket-like corners appear around selected Point icons with a blue fill
...
- **All shapes (except Points with icons)**: Line width increases by 2 pixels
