...
2. **Highlight** (optional, non-icon-Point shapes): A highlight layer underneath with:
...
- **Hover**: Curtain walls and indicator lines brighten to 1.5x their base color
- **Selection**: Curtain walls and indicator lines change to the `highlightColor`
- **Hover + Selection**: Curtain walls use a brighter version of the highlight color
