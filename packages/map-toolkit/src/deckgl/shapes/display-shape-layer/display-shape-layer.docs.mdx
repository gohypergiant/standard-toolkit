...
4. **Coffin corners** (Point shapes with icons): Bracket-like corners appear with a blue fill and black outline. The fill color defaults to `[57, 183, 250, 255]` (`#39B7FA`, fully opaque) and can be customized via `coffinCornerColor` (RGBA 0-255) when using the `CoffinCornerExtension` directly.
