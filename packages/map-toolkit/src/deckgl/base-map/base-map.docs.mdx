...
- **Tilt & Rotate**: Right-drag (or ctrl + left-drag) rotates the bearing and pitches the camera, driven through the camera store (left-drag still pans). A tilt gesture in flat `'2D'` auto-promotes the view to `'2.5D'`
