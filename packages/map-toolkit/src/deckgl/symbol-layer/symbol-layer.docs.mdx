...
The `CoffinCornersExtension` renders GPU-driven bracket indicators around selected and hovered symbols. Pair it with `useCoffinCorner` for click/hover state management.

```tsx
import '@accelint/map-toolkit/deckgl/symbol-layer/fiber';
import { uuid } from '@accelint/core';
import { BaseMap } from '@accelint/map-toolkit/deckgl';
import { CoffinCornersExtension, useCoffinCorner } from '@accelint/map-toolkit/deckgl/extensions/coffin-corner';
...
| `coffinCornerColor` | `[R, G, B, A]` (0–255) | Bracket color override (default: `[57, 183, 250, 255]`) |
