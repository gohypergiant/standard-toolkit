...
|------|------|-------------|
| `selectedEntityIds` | `ReadonlySet<EntityId> \| undefined` | Set of selected entity IDs (colored brackets) |
| `hoveredEntityIds` | `ReadonlySet<EntityId> \| undefined` | Set of hovered entity IDs (white brackets with background fill) |
